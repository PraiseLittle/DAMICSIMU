...
G4VPhysicalVolume* DAMICDetectorConstruction::Construct()
{
  ...
  G4Box* muonsBox = new G4Box("muonsBox", 100*mm, 100*mm, 40*mm);
  ...
  G4PVPlacement* muonsPV = new G4PVPlacement(0, G4ThreeVector(0, 0, 0.8*m), muonsLV, "muonsPV", WorldLV, false, 0, fCheckOverlaps);
