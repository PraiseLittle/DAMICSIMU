...
G4LogicalVolume* GetConstructionModule44(){
  G4double ModuleX = 500*mm;
  G4double ModuleY = 500*mm;
  G4double ModuleZ = 500*mm;
  G4Box* ModuleBox = new G4Box("ModuleBox", ModuleX, ModuleY, ModuleZ);
  G4Material* Air = G4Material::GetMaterial("G4_AIR");
  G4LogicalVolume* Module44LV = new G4LogicalVolume(ModuleBox, Air,"Module44LV");
  ...
  G4LogicalVolume* CopperTopPlate44LV = GetConstructionCopperTopPlate44();
   ...
   /*-----------PosCopperBasePlate-------*/
   G4double PosZCopperBasePlate = -2.6162*mm+1.0033*mm;
   G4double PosYCopperBasePlate = 0;
   G4double PosXCopperBasePlate = 0;
   G4ThreeVector VectCopperBasePlate = G4ThreeVector(PosXCopperBasePlate,PosYCopperBasePlate,PosZCopperBasePlate);

   /*---------PosSubAssy-----*/
   G4double PosSubAssyZ = PosZCopperBasePlate + 1.0033*mm+0.6096*mm ;
   G4double PosSubAssyY =0;
   G4double PosSubAssyX = 0*mm;
   ...
   /*-------PosCopperTopPlate-----*/
   G4double PosZTop = PosSubAssyZ + 1.0033*mm + 0.6096*mm;
   G4double PosYTop = 0;
   G4double PosXTop = 12.6365*mm;
   G4ThreeVector VectTopPlate = G4ThreeVector(PosXTop,PosYTop,PosZTop);
   /*------PosProtectiveCover-----*/
   G4double PosProtectiveZ = PosSubAssyZ + 0.6*mm + 0.25/2*mm;
   ...
   /*--------PosCopperMountBar-----*/
   G4double PosBarZ = PosZCopperBasePlate+1.0033*mm;
   G4double PosBarY = 0;
   G4double PosBarX = -55.5625*mm+0.635*mm;
...
G4LogicalVolume* GetConstructionModule42(){
  G4double ModuleX = 500*mm;
  G4double ModuleY = 500*mm;
  G4double ModuleZ = 500*mm;
  G4Box* ModuleBox = new G4Box("ModuleBox", ModuleX, ModuleY, ModuleZ);
  G4Material* Air = G4Material::GetMaterial("G4_AIR");
  G4LogicalVolume* Module42LV = new G4LogicalVolume(ModuleBox, Air,"Module42LV");

  G4LogicalVolume* CopperBasePlateLV = GetConstructionCopperBasePlate();
  G4LogicalVolume* CopperMountBarLV = GetConstructionCopperMountBar();
  G4LogicalVolume* ProtectiveCoverLV = GetConstructionProtectiveCover();
  G4LogicalVolume* SubAssyLV = GetConstructionCCDSubAssy42();
  G4LogicalVolume* CopperTopPlate42LV = GetConstructionCopperTopPlate42();
   ...
   G4PVPlacement* CopperBasePlatePV = new G4PVPlacement(0, VectCopperBasePlate, CopperBasePlateLV, "CopperBasePlatePV", Module42LV, false, 0, false);
   G4PVPlacement* CopperMountBarPV = new G4PVPlacement(RotPosBar, VectPosBar, CopperMountBarLV, "CopperMountBarPV", Module42LV, false, 0, false);
   G4PVPlacement* ProtectiveCoverPV = new G4PVPlacement(0, VectProtective, ProtectiveCoverLV, "ProtectiveCoverPV", Module42LV, false, 0, false);
   G4PVPlacement* SubAssyPV = new G4PVPlacement(RotSubAssy, VectSubAssy, SubAssyLV, "SubAssyPV", Module42LV, false, 0, false);
   G4PVPlacement* CopperTopPlate42PV = new G4PVPlacement(0, VectTopPlate, CopperTopPlate42LV, "CopperTopPlate42PV", Module42LV, false, 0, false);
...
{
  G4double SubX = 500*mm;
  G4double SubY = 500*mm;
  G4double SubZ = 500*mm;
  G4Box* SubBox = new G4Box("SubBox", SubX, SubY, SubZ);
  G4Material* Air = G4Material::GetMaterial("G4_AIR");
  G4LogicalVolume* SubLV = new G4LogicalVolume(SubBox, Air,"Module44LV");
  ...
  /*---------SensorPos----------*/
  G4double PosZSensor = -0.6*mm+0.30/2;
  G4double PosYSensor = 0;
  G4double PosXSensor = -13.208*mm;
  G4ThreeVector VectSensor = G4ThreeVector(PosXSensor, PosYSensor, PosZSensor);
  /*----------FlexCablePos-----------*/
  G4double PosZFlexCable = PosZSensor+ 0.25/2*mm+0.30/2*mm;
  G4double PosYFlexCable = 0;
  G4double PosXFlexCable = 0;
  G4ThreeVector VectFlexCable = G4ThreeVector(PosXFlexCable,PosYFlexCable , PosZFlexCable);

  /*-----------SiliconSubstratePos----------*/
  G4double PosZSiliconSubstrate = PosZFlexCable+0.3048/2*mm+0.65/2*mm;
  G4double PosYSiliconSubstrate = 0;
  G4double PosXSiliconSubstrate = -12.3444*mm;
...
G4LogicalVolume* GetConstructionCCDSubAssy42()
{
  G4double SubX = 500*mm;
  G4double SubY = 500*mm;
  G4double SubZ = 500*mm;
  ...
  G4LogicalVolume* CCDSensor42LV = GetConstructionCCDSensor42();
  G4LogicalVolume* SiliconSubstrate42LV = GetConstructionSiliconSubstrate42();
  G4LogicalVolume* FlexCable42LV = GetConstructionFlexCable42();


  /*-----------SiliconSubstratePos----------*/
  G4double PosZSiliconSubstrate = -1.4652/2*mm+0.25*mm;
  G4double PosYSiliconSubstrate = 0;
  G4double PosXSiliconSubstrate = -45.1993*mm+11.8618*mm+20.574*mm;
  G4ThreeVector VectSiliconSubstrate = G4ThreeVector(PosXSiliconSubstrate, PosYSiliconSubstrate, PosZSiliconSubstrate);
  G4ThreeVector uSilicon = G4ThreeVector(0,-1,0);
  G4ThreeVector vSilicon = G4ThreeVector(1,0,0);
  G4ThreeVector wSilicon = G4ThreeVector(0,0,1);
  G4RotationMatrix* RotSilicon = new G4RotationMatrix(uSilicon, vSilicon, wSilicon);

  /*----------FlexCablePos-----------*/
  G4double PosZFlexCable = PosZSiliconSubstrate+0.3048/2*mm+0.25*mm;
  G4double PosYFlexCable = 0;
  G4double PosXFlexCable = 0;
  G4ThreeVector VectFlexCable = G4ThreeVector(PosXFlexCable,PosYFlexCable , PosZFlexCable);

  /*---------SensorPos----------*/
  G4double PosZSensor = PosZFlexCable+0.3048/2*mm+0.6604/2*mm;
  G4double PosYSensor = 0;
  G4double PosXSensor = PosXSiliconSubstrate;
  G4ThreeVector VectSensor = G4ThreeVector(PosXSensor, PosYSensor, PosZSensor);
  ...
  G4PVPlacement* CCDSensor42PV = new G4PVPlacement(RotSensor, VectSensor, CCDSensor42LV, "CCDSensor42PV", SubLV, false, 0, false);
  G4PVPlacement* SiliconSubstrate42PV = new G4PVPlacement(RotSilicon, VectSiliconSubstrate, SiliconSubstrate42LV, "SiliconSubstrate42PV", SubLV, false, 0, false);
  G4PVPlacement* FlexCable42PV = new G4PVPlacement(0, VectFlexCable, FlexCable42LV, "FlexCable42PV", SubLV, false, 0, false);
...
G4LogicalVolume* GetConstructionCopperBasePlate()
{
  ...
  G4double boxZBase = 2.0066*mm;
  G4double rmBoxX = 77.216*mm;
  G4double rmBoxY = 86.7664;
  ...
  G4double posRMBoxZ = 2.0066/2*mm;
...
G4LogicalVolume* GetConstructionProtectiveCover()
{
  ...
  G4Material* Copper = G4Material::GetMaterial("G4_Cu");
  G4LogicalVolume *protectiveCover= new G4LogicalVolume(protectiveCoverFinal, Copper,"ProtectiveCover");
...
G4LogicalVolume* GetConstructionCCDSensor44(){
  ...
  G4Material* Copper = G4Material::GetMaterial("G4_Cu");
  G4LogicalVolume *CCDSensor= new G4LogicalVolume(mainBox, Copper,"CCDSensor");
...
G4LogicalVolume* GetConstructionCCDSensor42(){

  G4double mainBoxX = 64.292*mm;
  G4double mainBoxY = 32.605*mm;
  G4double mainBoxZ = 0.25*mm;
  G4double rmBoxX = (mainBoxX-1.426*2)*mm;
  G4double rmBoxY = (mainBoxY-0.943*2)*mm;
  G4double rmBoxZ =0.500*mm;
  ...
  G4SubtractionSolid * CCDSensorFinal = new G4SubtractionSolid("CCDSensorFinal", mainBox, rmBox, Tr0);

  G4Material* Copper = G4Material::GetMaterial("G4_Cu");
  G4LogicalVolume *CCDSensor= new G4LogicalVolume(CCDSensorFinal, Copper,"CCDSensor");
...
G4LogicalVolume* GetConstructionSiliconSubstrate44(){
  ...
  G4Material* Copper = G4Material::GetMaterial("G4_Cu");
  G4LogicalVolume* siliconSubstrate = new G4LogicalVolume(siliconSubstrateFinal, Copper, "SiliconSubstrate");

  return siliconSubstrate;
}

G4LogicalVolume* GetConstructionSiliconSubstrate42(){

  G4double mainBoxX = 88.90*mm;
  G4double mainBoxY = 41.28*mm;
  G4double mainBoxZ = 0.65*mm;
  ...
  G4Material* Copper = G4Material::GetMaterial("G4_Cu");
  G4LogicalVolume* siliconSubstrate = new G4LogicalVolume(mainBox, Copper, "SiliconSubstrate");
...
G4LogicalVolume* GetConstructionCopperTopPlate44(){
  ...
  G4double mainBoxZ = 2.0066*mm;
  G4double rmBoxX1 = 67.31*mm;
  G4double rmBoxY1 = 66.7004*mm;
  G4double rmBoxZ1 = 2.0066*mm;
  G4double rmBoxX2 = 10.033*mm;
  G4double rmBoxY2 = 10.033*mm;
  G4double rmBoxZ2 = 2.0066*mm;
...
G4LogicalVolume* GetConstructionCopperTopPlate42(){

  G4double mainBoxX = 85.852*mm;
  G4double mainBoxY = 101.6*mm;
  G4double mainBoxZ = 2.0066*mm;
  G4double rmBoxX1 = 38.1*mm;
  G4double rmBoxY1 = 73.3044*mm;
  G4double rmBoxZ1 = 2.0066*mm;
  G4double rmBoxX2 = 10.033*mm;
  G4double rmBoxY2 = 10.033*mm;
  G4double rmBoxZ2 = 2.0066*mm;
...
G4LogicalVolume* GetConstructionFlexCable44()
{
  ...
  G4double longPartFlexZ = 0.3048*mm;
  G4double boxMainX = 90.3986*mm;
  G4double boxMainY = 101.6*mm;
  G4double boxMainZ = 0.3048*mm;
  G4double rmBox1X = 77.6986*mm;
  G4double rmBox1Y = 67.4116*mm;
  G4double rmBox1Z = 0.3048*mm;
  G4double rmBox2X = 12.7*mm;
  G4double rmBox2Y = 82.55*mm;
  G4double rmBox2Z = 0.3048*mm;
...
G4LogicalVolume* GetConstructionFlexCable42()
{
  G4double longPartFlexX = 482.6*mm;
  G4double longPartFlexY = 25.4*mm;
  G4double longPartFlexZ = 0.3048*mm;
  G4double boxMainX = 90.3986*mm;
  G4double boxMainY = 101.6*mm;
  ...
  G4double rmBox1Y = 67.4116*mm;
  G4double rmBox1Z = 0.3048*mm;
  G4double rmBox2X = 24.5618*mm;
  G4double rmBox2Y = 82.55*mm;
  G4double rmBox2Z = 0.3048*mm;
  G4double rmBox3X = 11.8618*mm;
  G4double rmBox3Y = 88.9*mm;
  G4double rmBox3Z = 0.3048*mm;

  G4Box* longPartFlex = new G4Box("LongPartFlex", longPartFlexX/2, longPartFlexY/2, longPartFlexZ/2);
  G4Box* boxMain = new G4Box("BoxMain", boxMainX/2, boxMainY/2, boxMainZ/2);
  G4Box* rmBox1 = new G4Box("RmBox1", rmBox1X, rmBox1Y/2, rmBox1Z);
  G4Box* rmBox2 = new G4Box("RmBox2", rmBox2X/2, rmBox2Y/2, rmBox2Z);
  G4Box* rmBox3 = new G4Box("RmBox3", rmBox3X, rmBox3Y/2, rmBox3Z);
  ...
  G4double posRmBox3X = -boxMainX/2;
  G4ThreeVector posRmBox3Vect = G4ThreeVector(posRmBox3X,0,0);
  G4Transform3D posRmBox3Tr = G4Transform3D(*rot0, posRmBox3Vect);
  ...
  G4SubtractionSolid* flex1 = new G4SubtractionSolid("Flex1", boxMain, rmBox1, posRmTr);
  G4SubtractionSolid* flex2 = new G4SubtractionSolid("Flex2", flex1, rmBox2, posRmBox2Tr);
  G4SubtractionSolid* flex3 = new G4SubtractionSolid("Flex3", flex2, rmBox3, posRmBox3Tr);
  //G4UnionSolid* flexCableFinal = new G4UnionSolid("FlexCableFinal", flex3, longPartFlex, posLongPartTr);

  G4Material* Copper = G4Material::GetMaterial("G4_Cu");
  G4LogicalVolume* flexCable = new G4LogicalVolume(flex3, Copper, "FlexCable");
